...
@section('content')
        ...
        {{ csrf_field() }}
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="file" name="bg_image" id="bg_image">
            </div>
            <!-- <div class="mb-3">
            ...
            <!-- <div class="mb-3">
                ...
                <input type="text" class="form-control" name="theme_color" id="theme_color">
            </div>

            <div class="mb-3">
                <label for="btn_color" class="form-label">Button Color</label>
                <input type="text" class="form-control" name="btn_color" id="btn_color">
            </div> -->
